...
sign_kinematic_tree = [[0, 2, 5, 8, 11], [0, 1, 4, 7, 10],
    [0, 3, 6, 9, 12, 15],
    [9, 14, 17, 19, 21],
    [9, 13, 16, 18, 20],
    [21, 38, 39, 40],      # Right index finger
    [21, 41, 42, 43],      # Right middle finger
    [21, 44, 45, 46],      # Right ring finger
    [21, 47, 48, 49],      # Right little finger
    [21, 50, 51, 52],      # Right thumb

    [20, 23, 24, 25],      # Left index finger
    [20, 26, 27, 28],      # Left middle finger
    [20, 29, 30, 31],      # Left ring finger
    [20, 32, 33, 34],      # Left little finger
    [20, 35, 36, 37],      # Left thumb

    [15, 22],              # Head to jaw
    [22, 53],

    [53, 58, 59],             # Upper-lip center to lower-lip center
    [53, 54],                 # Nose to right eye
    [53, 55],                 # Nose to left eye
    [54, 56, 59],             # Right eye to right ear
    [55, 57, 59],             # Left eye to left ear
